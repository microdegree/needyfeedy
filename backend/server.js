...
var DonorController = require('./controller/AdminController');
app.use('/api/admin', DonorController);

var NgoController = require('./controller/ConsumerController');
app.use('/api/consumer', NgoController);
