                    ...
                    <Card.Body>
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <select name="role" ref={register({ required: true })}>
                                <option value="ngoRole">Ngo</option>
                                <option value="donorRole">Donors</option>
    ...
    function updateSignupInfoInServer(requestObject) {
        ...
        fetch('/api/authenticate/signUp', {
            ...
            .then(data => {
                ...
                if ('ngoRole' === requestObject.role) {
                    auth.authenticated = true;
                    console.log('in patient flow signup')
                    props.routeHistory.push("/ngoDashboard");
                } else if ('donorRole' === requestObject.role) {
                    auth.authenticated = true;
                    props.routeHistory.push("/donorDashboard");
