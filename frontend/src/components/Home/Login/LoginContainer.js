...
const LoginContainer = props => {
    ...
    return (
        <div>
            ...
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'donorRole') }); }}>ByPass Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'ngoRole') }); }}>ByPass Consumer Login</Button>{' '}
